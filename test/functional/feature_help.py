...
"""Verify that starting smicoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start smicoin with -h for help text")
        ...
        self.log.info("Start smicoin with -version for version information")
        ...
        self.log.info("Start smicoind with -fakearg to make sure it does not start")
