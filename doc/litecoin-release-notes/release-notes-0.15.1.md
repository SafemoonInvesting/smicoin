Smicoin Core version *0.15.1* is now available from:

  <https://download.smicoin.org/smicoin-0.15.1/>
...
A number of changes to the way Smicoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 smis per kB (0.00001 SMI). This is to prepare for dropping the minimum transaction fee to 0.1 smis per kB (0.0001 SMI) in the next release.
