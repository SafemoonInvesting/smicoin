# Support for Output Descriptors in Smicoin Core

Since Smicoin Core v0.17, there is support for Output Descriptors. This is a
...
on Smicoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Smicoin Core wallets, a convenience function `combo` is
