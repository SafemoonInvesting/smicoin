...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " smicoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  smicoin-tx [options] <hex-tx> [commands]  Update hex-encoded smicoin transaction\n" +
            "or:     smicoin-tx [options] -create [commands]   Create hex-encoded smicoin transaction\n" +
            "\n";
