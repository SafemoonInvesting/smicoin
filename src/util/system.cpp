...
const char * const BITCOIN_CONF_FILENAME = "smicoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Smicoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Smicoin";
#else
    // Unix
    return pathRet / ".smicoin";
#endif
#endif
}
